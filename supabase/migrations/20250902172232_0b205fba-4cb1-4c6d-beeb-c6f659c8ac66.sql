...
-- 2) Temporarily modify the function to allow admin role and service role to change email_verified
...
-- 3) Set email_verified to true for brugge@stijnswinnen.be (idempotent)
