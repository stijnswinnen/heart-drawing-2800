...
-- Manually verify the specific user using the proper function
SELECT verify_user_email('fons@stijnswinnen.be', '56009b28-5e3c-4329-983c-8cca1118940b'::uuid);
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'location_id', '072595e5-6db4-4274-273b-331c6a2b0ccb',
    'timestamp', NOW()
  )
);